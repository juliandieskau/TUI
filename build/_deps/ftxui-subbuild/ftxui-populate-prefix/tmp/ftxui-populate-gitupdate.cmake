...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "v4.0.0"
  WORKING_DIRECTORY "/workspaces/tui/build/_deps/ftxui-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v4.0.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v4.0.0")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/tui/build/_deps/ftxui-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/tui/build/_deps/ftxui-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
