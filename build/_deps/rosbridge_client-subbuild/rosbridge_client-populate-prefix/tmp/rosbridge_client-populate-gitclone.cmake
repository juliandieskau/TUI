...
while(error_code AND number_of_tries LESS 3)
  execute_process(
    COMMAND "/usr/local/bin/git"  clone --no-checkout "https://git.scc.kit.edu/pse-robot-monitoring/rosbridge_client_cpp.git" "rosbridge_client-src"
...
if(error_code)
  message(FATAL_ERROR "Failed to clone repository: 'https://git.scc.kit.edu/pse-robot-monitoring/rosbridge_client_cpp.git'")
endif()
