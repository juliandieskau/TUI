...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "v2018"
  WORKING_DIRECTORY "/workspaces/tui/build/_deps/rosbridge_client-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v2018")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2018")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://git.scc.kit.edu/pse-robot-monitoring/rosbridge_client_cpp.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/workspaces/tui/build/_deps/rosbridge_client-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/workspaces/tui/build/_deps/rosbridge_client-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
