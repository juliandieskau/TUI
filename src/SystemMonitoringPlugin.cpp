...
void SystemMontitoringPlugin::subscribeToROS(){ 
  ...
  rosbridge_client_cpp::Subscriber my_sub2(*ros, "/ects/system/cpu/usage", "CpuUsage", my_callback2, 5);
  cpuusagesub = &my_sub2;
  ...
  rosbridge_client_cpp::Subscriber my_sub3(*ros, "/ects/system/cpu/percent", "CpuPercentage", my_callback3, 5);
  cpupersub = &my_sub3;
  ...
  rosbridge_client_cpp::Subscriber my_sub4(*ros, "/ects/system/mem/usage", "MemoryUsage", my_callback4, 5);
  memusagesub = &my_sub4;
  //Total processes
  ...
  rosbridge_client_cpp::Subscriber my_sub7(*ros, "/ects/system/processes/total", "ProcessTotal", my_callback7, 5);
  ...
  auto my_callback5 = [&](const picojson::object& json1){ 
    ...
    for ( int index = 0; index < mount.size(); ++index )
    {
      ...
      rosbridge_client_cpp::Subscriber my_sub6(*ros, topic, "DiskUsage", my_callback6 , 5);
  ...
  rosbridge_client_cpp::Subscriber my_sub5(*ros, "/ects/system/disk/mountpoints", "MountpointList", my_callback5, 5);
  mountsub = &my_sub5;
  //Networkinfo
  ...
  auto my_callback8 = [&](const picojson::object& json1){ 
    ...
    for ( int index = 0; index < adapter.size(); ++index )
    {
      ...
      rosbridge_client_cpp::Subscriber my_sub9(*ros, topic1, "NetworkInfo", my_callback9, 5);
      netinfosub.push_back(&my_sub9);
      std::string topic2 = "/ects/system/network/" + adapter[index].to_str() + "/usage";
      rosbridge_client_cpp::Subscriber my_sub10(*ros, topic2, "NetworkUsage", my_callback10, 5);
  ...
  rosbridge_client_cpp::Subscriber my_sub8(*ros, "/ects/system/network/adapters", "AdapterList", my_callback8, 5);
  adaptersub = &my_sub8;
